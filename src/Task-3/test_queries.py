...
client = MongoClient('mongosh "mongodb+srv://m165cluster.m9lf4.mongodb.net/" --apiVersion 1 --username "Dylano"')
db = client['restaurants']
collection = db['restaurants']

def top_bewertete_restaurants():
...
def finde_naechstes_restaurant(restaurant_name="Le Perigord"):
